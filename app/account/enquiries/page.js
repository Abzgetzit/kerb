    ...
    return (
      <main className="page">
        <section className="emptyCard">
          ...
          <p>You need to sign in to view your enquiries.</p>
  ...
  return (
    <main className="page">
      ...
      <section className="hero">
        <div>
          <div className="pill">Buyer account</div>

          <h1>Your enquiries</h1>

          <p>
            These are the cars you have contacted sellers about using{" "}
      ...
      {isLoading ? (
        <div className="emptyBox">Loading your enquiries...</div>
      ) : enquiries.length === 0 ? (
        <div className="emptyBox">
          <h2>No enquiries yet</h2>
          <p>When you message a seller, your enquiry will appear here.</p>

          <Link href="/browse" className="primaryLink">
            Browse cars
          </Link>
        </div>
      ) : (
              ...
              <article className="card" key={enquiry.id}>
                <div className="cardHeader">
                  <div>
                    ...
                    <p>Sent {formatDate(enquiry.created_at)}</p>
                  </div>
